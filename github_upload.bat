@echo off
cd /d "%~dp0"
echo Konfigurowanie i wysylanie na GitHub (https://github.com/mihau07-creator/baza-base.git)...

:: Remove origin if it exists to ensure we set the new one correctly
git remote remove origin 2>nul

:: Add the remote
git remote add origin https://github.com/mihau07-creator/baza-base.git
